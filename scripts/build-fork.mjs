...
try {
  ...
  packagedJson.version = "2.1.3-fork.13";
  await fs.writeFile(
    packagedJsonPath,
  ...
  run("plutil", ["-replace", "CFBundleVersion", "-string", "2.1.3.13", plist]);
