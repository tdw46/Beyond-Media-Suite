...
try {
  ...
  packagedJson.version = "2.1.3-fork.18";
  await fs.writeFile(
    packagedJsonPath,
  ...
  run("plutil", ["-replace", "CFBundleVersion", "-string", "2.1.3.18", plist]);
