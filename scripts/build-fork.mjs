...
try {
  ...
  packagedJson.version = "2.1.3-fork.14";
  await fs.writeFile(
    packagedJsonPath,
  ...
  run("plutil", ["-replace", "CFBundleVersion", "-string", "2.1.3.14", plist]);
