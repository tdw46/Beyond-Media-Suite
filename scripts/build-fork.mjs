...
try {
  ...
  packagedJson.version = "2.1.3-fork.15";
  await fs.writeFile(
    packagedJsonPath,
  ...
  run("plutil", ["-replace", "CFBundleVersion", "-string", "2.1.3.15", plist]);
